...
const EffectDependenciesDemo = () => {
  ...
  // Effect 1: Tanpa dependencies (run setiap render)
  useEffect(() => {
    addLog('Effect tanpa dependencies dijalankan');
  });

  // Effect 2: Empty dependencies (mount only)
  useEffect(() => {
  ...
  // Effect 6: Window resize event listener
  useEffect(() => {
    const handleResize = () => {
